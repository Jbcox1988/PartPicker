    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update part locations, descriptions, and quantities from Parts List export
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="flex items-center gap-4">
            ...
            <span className="text-sm text-muted-foreground">
              Supports .xlsx files (e.g., Parts List.xlsx)
            </span>
          </div>
                  ...
                  <div className="mt-2 text-sm space-y-1">
                    ...
                    {lastSyncResult.notFoundCount > 0 && (
                      <p className="text-amber-600 dark:text-amber-400">
                        Not found in Parts List: <strong>{lastSyncResult.notFoundCount}</strong> line items
          ...
          <div className="text-sm text-muted-foreground space-y-2">
            ...
            <p className="text-xs mt-2">
              Pick counts are preserved - only metadata is updated.
            </p>
          </div>
